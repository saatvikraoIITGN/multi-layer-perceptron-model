...
def run_test_harness():
	...
	logs_vgg3 = "logs_vgg3/fit/vgg1_" + datetime.datetime.now().strftime("%H%M%S")
	tensorboard_callback = keras.callbacks.TensorBoard(log_dir=logs_vgg3, histogram_freq=1)
    # ----|
